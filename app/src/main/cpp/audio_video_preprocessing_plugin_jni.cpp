...
JNIEXPORT void JNICALL Java_io_agora_audiocustomization_rawdata_ex_AudioVideoPreProcessing_doRegisterPreProcessing
...
JNIEXPORT void JNICALL Java_io_agora_audiocustomization_rawdata_ex_AudioVideoPreProcessing_doDeregisterPreProcessing
        (JNIEnv *env, jobject obj)
{
    agora::util::AutoPtr<agora::media::IMediaEngine> mediaEngine;
    mediaEngine.queryInterface(rtcEngine, agora::AGORA_IID_MEDIA_ENGINE);
