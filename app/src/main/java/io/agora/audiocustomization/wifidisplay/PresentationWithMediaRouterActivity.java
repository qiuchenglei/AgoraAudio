...
package io.agora.audiocustomization.wifidisplay;
...
public class PresentationWithMediaRouterActivity extends Activity {
    private final String TAG = "PresentationMediaRouter";
    ...
    protected void onStop() {
        ...
        if (mPresentation != null) {
            Log.i(TAG, "Dismissing presentation, the activity is not visible.");
