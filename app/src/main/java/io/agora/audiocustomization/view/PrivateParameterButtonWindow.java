...
public class PrivateParameterButtonWindow {
    private PopupWindow mPopupWindow;
    private Context mCtx;
    private RecyclerView rcv;
    private RcvPrivateParameterBtnAdapter adapter;

    public PrivateParameterButtonWindow(Context ctx, RcvPrivateParameterBtnAdapter.OnItemClickListener onItemClickListener) {
        mCtx = ctx;
